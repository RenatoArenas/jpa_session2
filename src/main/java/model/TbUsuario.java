...
public class TbUsuario implements Serializable {
	...
	public TbUsuario(int codUsua, String apeUsua, String claUsua, int estUsua, Date fnaUsua, String nomUsua,
			String usrUsua, List<TbCabBoleta> tbCabBoletas, TbTipo tbTipo) {
		super();
